    ...
    <div className="flex flex-col gap-6">
      <div className="space-y-4 w-full">
        ...
        <div className="bg-white dark:bg-(--page-body-bg) rounded-lg border border-slate-200/60 dark:border-(--card-border-color) p-2 grid grid-cols-2 md:grid-cols-4 gap-2 shadow-sm">
          ...
          <div className=" p-3 col-span-2 md:col-span-2 flex flex-col justify-center border border-slate-100 dark:border-(--card-border-color) dark:bg-(--dark-body) hover:bg-slate-50 dark:hover:bg-(--table-hover) transition-colors rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <div className="text-slate-500">
                <FileText size={12} />
              </div>
